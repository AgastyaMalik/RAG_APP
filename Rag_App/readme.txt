...
This is my **RAG (Retrieval-Augmented Generation) App**. 

### Overview
This app is designed to demonstrate a local Retrieval-Augmented Generation (RAG) pipeline using:
...
1. Navigate to the `frontend` directory:
   ...
   cd frontend
   ```
2. Serve the HTML interface using Python:
   ```bash
